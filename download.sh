...
wget -P ./checkpoints/ https://storage.cloud.google.com/buttcket/imagenet.tar?authuser=1
tar xvf ./checkpoints/imagenet.tar 
# wget -P ./raven_data/ http://35.238.195.83/data_a_ab_c_d_e_with_mask_570x900_py3.pkl
wget -P ./raven_data/ https://storage.cloud.google.com/buttcket/data_a_ab_c_d_e_with_mask_570x900_py3.pkl?authuser=1
